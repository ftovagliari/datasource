...
(** When using pa_pgsql, database handles have type [pa_pg_data PGOCaml.t]
  *)
...
val execute : 'a t -> ?name:string -> ?portal:string -> params:param list -> unit -> 'a result_set
...
val execute_update : 'a t -> ?name:string -> ?portal:string -> params:param list -> unit -> unit
...
val close_result_set : 'a result_set -> unit
...
val next : 'a result_set -> string option array
